  ...
  return (
    <nav
      className={cn(
        ...
        scrolled ? "bg-background/95 backdrop-blur-sm border-b border-border/50 shadow-subtle py-3" : "py-5"
      )}
    >
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden bg-background/95 backdrop-blur-sm border-t border-border mt-2">
